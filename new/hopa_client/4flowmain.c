...
/*
    ...
    initialize_server_addr(&server_addr, "192.168.0.42", SERVER_PORT);
    ...
    return 0;
  */
    const char* local_ips[] = {"192.168.0.41", "192.168.0.213" , "192.168.0.122", "192.168.0.99"}; // 这只是一个示例，您可以随时添加更多的IP地址
    const char* remote_ip = "192.168.0.42";
    ...
    for (int i = 0; i < num_ips; i++) {
        ...
        initialize_server_addr(&server_addrs[i], remote_ip, SERVER_PORT);
